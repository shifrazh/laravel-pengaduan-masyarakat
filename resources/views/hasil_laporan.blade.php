  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="isipengaduan">Halaman pengaduan</a>
        </li>
        <li class="nav-item">
...
<body>
  ...
  <h1>isi pengaduan</h1> <a href="{{'isi-pengaduan'}}" type="button" class="btn btn-info" style="margin-left: 2rem;height:50px;width:50px;margin-top:1rem;">+</a>
  </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="table-secondary">
                <a href="{{'update'}}" type="button" class="btn btn-danger">update</a>
